 ...
 * </p>
 */
public class MultiEditorEditorSite implements IEditorSite, INestable {
	 ...
	 */
	private final MultiEditorEditorPart multiPageEditor;
	 ...
	 *
	 * @see MultiEditorEditorSite#setSelectionProvider(ISelectionProvider)
	 */
	 ...
	 */
	public MultiEditorEditorSite(MultiEditorEditorPart multiPageEditor, IEditorPart editor) {
	...
	private void initializeDefaultServices() {
		...
		serviceLocator.registerService(IMultiEditorEditorSiteHolder.class,
				(IMultiEditorEditorSiteHolder) () -> MultiEditorEditorSite.this);
	...
	private ISelectionChangedListener getPostSelectionChangedListener() {
		if (postSelectionChangedListener == null) {
			postSelectionChangedListener = MultiEditorEditorSite.this::handlePostSelectionChanged;
		}
	...
	private ISelectionChangedListener getSelectionChangedListener() {
		if (selectionChangedListener == null) {
			selectionChangedListener = MultiEditorEditorSite.this::handleSelectionChanged;
		}
	...
	protected void handlePostSelectionChanged(SelectionChangedEvent event) {
		...
		if (parentProvider instanceof MultiEditorSelectionProvider) {
			SelectionChangedEvent newEvent = new SelectionChangedEvent(parentProvider, event.getSelection());
			MultiEditorSelectionProvider prov = (MultiEditorSelectionProvider) parentProvider;
	 ...
	 * @see MultiEditorEditorSite#handleSelectionChanged(SelectionChangedEvent)
	 */
	@Override
